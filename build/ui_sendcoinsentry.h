...
public:
    ...
    void setupUi(QFrame *SendCoinsEntry)
    {
        ...
        SendCoinsEntry->resize(782, 347);
        SendCoinsEntry->setStyleSheet(QLatin1String("background-image: url(:/images/as1);\n"
"color: rgb(0, 170, 255);"));
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The address to send the payment to  (e.g. AbjZqgY4r2RoEdqYk3QsAqFckyf9pRHN6i)", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
