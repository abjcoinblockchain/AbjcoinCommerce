...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        CoinControlDialog->setStyleSheet(QLatin1String("background-image: url(:/images/as1);\n"
"color: rgb(0, 170, 255);"));
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 ABJC"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 ABJC"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 ABJC"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 ABJC"));
