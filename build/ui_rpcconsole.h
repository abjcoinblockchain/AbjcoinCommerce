...
public:
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        RPCConsole->setStyleSheet(QLatin1String("background-image: url(:/images/as1);\n"
"color: rgb(0, 170, 255);"));
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "AbjcoinCommerce - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "AbjcoinCommerce Core", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the AbjcoinCommerce debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the AbjcoinCommerce-Qt help message to get a list with possible AbjcoinCommerce command-line options.", 0));
#endif // QT_NO_TOOLTIP
